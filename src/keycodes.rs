...
pub const CATALOG: &[Category] = &[
    ...
    Category {
        ...
        keys: &[
            ...
            k!("KC_PASTE", "Paste"),
            k!("KC_FIND", "Find"),
            k!("LCTL(KC_A)", "Select all"),
            k!("LCTL(KC_S)", "Save"),
            k!("LGUI(KC_C)", "⌘C"),
            k!("LGUI(KC_V)", "⌘V"),
            k!("LGUI(KC_Z)", "⌘Z"),
            k!("LGUI(KC_SPACE)", "Spotlight"),
            k!("LALT(KC_TAB)", "⌥Tab"),
            k!("LGUI(KC_TAB)", "⌘Tab"),
        ],
    },
    ...
    Category {
        ...
        keys: &[
            ...
            k!("KC_SLEP", "Sleep"),
            k!("KC_WAKE", "Wake"),
            k!("QK_BOOT", "Bootloader"),
            k!("EE_CLR", "Clear EEPROM"),
            k!("QK_RBT", "Reboot"),
        ],
    },
    Category {
        ...
        keys: &[
            ...
            k!("KC_MS_L", "Move ←"),
            k!("KC_MS_R", "Move →"),
            k!("KC_BTN1", "Left click"),
            k!("KC_BTN2", "Right click"),
            k!("KC_BTN3", "Middle click"),
            k!("KC_BTN4", "Button 4"),
            k!("KC_BTN5", "Button 5"),
            k!("KC_WH_U", "Wheel ↑"),
            k!("KC_WH_D", "Wheel ↓"),
    ...
    Category {
        ...
        keys: &[
            ...
            k!("KC_HYPR", "Hyper"),
            k!("KC_MEH", "Meh"),
            k!("OSM(MOD_LSFT)", "One-shot Shift"),
            k!("OSM(MOD_LGUI)", "One-shot Cmd"),
        ],
    },
    Category {
        name: "Layers",
        templated: true,
        keys: &[
            k!("MO({n})", "Momentary L{n}"),
            k!("TO({n})", "Switch to L{n}"),
            k!("TG({n})", "Toggle L{n}"),
            k!("TT({n})", "Tap-toggle L{n}"),
            k!("OSL({n})", "One-shot L{n}"),
            k!("DF({n})", "Default L{n}"),
    ...
    Category {
        ...
        templated: false,
        keys: &[
            k!("RGB_TOG", "Toggle RGB"),
            k!("RGB_MOD", "Next mode"),
            k!("RGB_RMOD", "Prev mode"),
            k!("RGB_HUI", "Hue +"),
            k!("RGB_HUD", "Hue -"),
            k!("RGB_SAI", "Sat +"),
            k!("RGB_SAD", "Sat -"),
            ...
            k!("RGB_SPD", "Speed -"),
            k!("RGB_SLD", "Solid"),
            k!("TOGGLE_LAYER_COLOR", "Toggle layer colors"),
    ...
    Category {
        name: "Special",
        templated: false,
        keys: &[k!("KC_TRNS", "▽ Transparent"), k!("KC_NO", "✗ Disabled")],
    },
];
...
pub fn needs_extrakey(code: &str) -> bool {
    const P: &[&str] = &[
        "KC_MPLY", "KC_MNXT", "KC_MPRV", "KC_MSTP", "KC_MUTE", "KC_VOL", "KC_BRIU", "KC_BRID",
        "KC_MSEL", "KC_PWR", "KC_SLEP", "KC_WAKE",
    ];
    P.iter().any(|p| code.contains(p))
}
